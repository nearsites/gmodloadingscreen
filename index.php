...
$SteamAPIKey = "29A5AF97859644112BC6E681A4D8E4D4";
...
<html>
    ...
    <div class="core-wrapper"><!-- Opens the wrapper so we can contain and center everything -->
		...
		<h2>About Us</h2>
            ...
            <div id="box">
		<p> Welcome to the open-beta of the server, here's some basic info. Firstly, staff applications are open, many more jobs and add-ons will be inlcuded in the future. There will be a way to make real money on the server, just as an added perk of being part of our new community we're trying to build. Our discord server should be up and running shortly where suggestions/fixes can be made. Thanks, and have fun!</p>
	</div>
